...
func TestGetCellNumbers(t *testing.T) {
	...
	cases := []CellNumbersTestCase{
		{3, 3, map[int]int{1: 1}, [][]int{{1, 1, 1}, {1, 0, 1}, {1, 1, 1}}},
		{3, 3, map[int]int{1: 2}, [][]int{{0, 1, 1}, {0, 1, 0}, {0, 1, 1}}},
		{3, 3, map[int]int{0: 2}, [][]int{{0, 1, 0}, {0, 1, 1}, {0, 0, 0}}},
		{3, 3, map[int]int{0: 2, 1: 1}, [][]int{{1, 2, 0}, {1, 0, 2}, {1, 1, 1}}},
	}
	for _, c := range cases {
